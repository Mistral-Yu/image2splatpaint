...
function growParamPlaceholders(params, targetCount) {
  ...
  return {
    ...
    ...(params.flowBirthLinksEnabled ? {
      ...
      flowAlternatingStructureEnabled: Boolean(params.flowAlternatingStructureEnabled),
      flowStructureUpdateInterval: params.flowStructureUpdateInterval || 3,
      flowStructureImageAnchor: params.flowStructureImageAnchor || 0,
      flowStrokeEndWidth: params.flowStrokeEndWidth || .75,
      flowStrokeCenterWidth: params.flowStrokeCenterWidth || 1.6,
